...
func getPresentVerbs() map[string]string {
	return map[string]string{
		...
		"Я дивлюсь (pronounced: dyv-li-os)":                           "I watch",
...
func getPartOfHouse() map[string]string {
	return map[string]string{
		"Вхід Vkhid (pronounced: vkhid)":                            "Entrance",
		"Передпокій Peredpokiy (pronounced: peh-red-poh-kee)":       "Hallway",
		"Вітальня Vitayalnya (pronounced: vee-tahil-nya)":           "Living room",
		"Кухня Kukhnya (pronounced: kookh-nya)":                     "Kitchen",
		"Ванна Vanna (pronounced: vah-nah)":                         "Bathroom",
		"Туалет Tualet (pronounced: too-ah-let)":                    "Toilet",
		"Спальня Spalnya (pronounced: spahl-nya)":                   "Bedroom",
		"Кабінет Kabinet (pronounced: kah-bee-net)":                 "Office",
		"Балкон Balkon (pronounced: bal-kon)":                       "Balcony",
		"Гараж Garazh (pronounced: gah-razh)":                       "Garage",
		"Подвір Podvir'ya (pronounced: pod-veer-ya)":                "Yard",
		"Перший Pershyy poverkh (pronounced: pehr-shyy poh-vehrkh)": "First floor",
		"Другий Druhyy poverkh (pronounced: droo-hyy poh-vehrkh)":   "Second floor",
		"Покрівля Pokrivlya (pronounced: pok-reev-lya)":             "Roof",
		"Вікно Vikno (pronounced: vik-no)":                          "Window",
		"Двері Dveri (pronounced: dveh-ree)":                        "Door",
		"Сходи Skhody (pronounced: skhoh-dy)":                       "Stairs",
		"Підвал Pidval (pronounced: pid-val)":                       "Basement",
		"Спальня Spalnya batkiv (pronounced: spahl-nya baht-keev)":  "Master bedroom",
		"Паркан Parkan (pronounced: par-kan)":                       "Fence",
	}
}
